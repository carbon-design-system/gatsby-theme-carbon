...
1. Shadowing theme components
1. Shadowing anything processed by webpack

<Notes>

Actual first: Oh wow I really just had to write markdown though
Developers need to do at least the first one
...
[shadowing docs](https://gatsby-theme-carbon.now.sh/guides/shadowing)
