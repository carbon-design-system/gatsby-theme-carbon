...
import { Misuse24 } from '@carbon/icons-react';
...
export default class Dont extends React.Component {
  static propTypes = {
  ...
  render() {
    ...
    const iconClassNames = classnames({
      [exampleIcon]: true,
      [exampleIconIncorrect]: true,
    });

    const wrapperClassNames = classnames({
      [example]: true,
      [exampleIncorrect]: true,
