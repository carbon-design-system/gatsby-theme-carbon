...
import linesToCopy from './lines-to-copy';
...
const Sidebar = ({ src, path, copyLineStart, copyLineLength, children }) => {
    ...
    <div className={sidebar}>
      {shouldShowCopyButton && (
        <CopyButton
          ...
          onClick={() => {
            copy(linesToCopy(children, copyLineStart, copyLineLength));
          }}
        />
      )}
      {shouldShowSrcLink && (
