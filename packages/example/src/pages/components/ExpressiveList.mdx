...
<Title>Using `titleType=expressive-04` *please check props section for more info on usage*</Title>
...
<Title>Using `titleType=expressive-02` *please check props section for more info on usage*</Title>
...
| titleType  | string   |          |          | Optional prop used for type options - default is `expressive-03`. Options are: `expressive-04` and `expressive-02` |
