...
```mdx path=components/ImageCard/ImageCard.js src=https://github.com/carbon-design-system/gatsby-theme-carbon/tree/master/packages/gatsby-theme-carbon/src/components/ImageCard
<Row className="image-card-group">
  <Column colMd={4} colLg={4} noGutterSm>
