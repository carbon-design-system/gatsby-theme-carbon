...
import heroPoster from './images/poster.png';
...
<Video src={heroVideo} poster={heroPoster} />
...
```markdown path=components/Video.mdx src=https://github.com/carbon-design-system/gatsby-theme-carbon/blob/master/packages/example/src/pages/components/Video.mdx
...
| poster   | string                                                                       | only with `src` |         | Provides an image to show before the video loads, only works with `src`                                                                                                                                                                                                                                                                  |
