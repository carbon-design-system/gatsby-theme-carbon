...
| --------------------- | -------- | -------- | ------- | ----------------------------------------------------------------------- |
| children              | node     | yes      |         |                                                                         |
| className             | string   | no       |         | Add custom class name                                                   |
| addPaddingWhenWrapped | boolean  | no       | true    | True if vertical padding should be added to children when the row wraps |
...
<Title>Padding when wrapped</Title>

```jsx path=components/Grid.js src=https://github.com/carbon-design-system/gatsby-theme-carbon/tree/master/packages/gatsby-theme-carbon/src/components/Grid
{
  /* addPaddingWhenWrapped will padd all of a rows children or an individual column */
  /* some theme components have this prop disabled by default */
}
