...
To update the source account for this component, pass a `mediumAccount` or an array of Medium accounts (for multiple accounts) in 
your theme options within `gatsby-config.js`.
