...
The `<Aside>` component is a wrapper component that adds styling to make the text display smaller than the default body text; using`body-long-01` and adds the correct top border styles. It will likely be used within a smaller `<Column>` width.
