...
You can view a list of included languages at the [react-prism-renderer repo](https://github.com/FormidableLabs/prism-react-renderer/blob/main/src/vendor/prism/includeLangs.js).
