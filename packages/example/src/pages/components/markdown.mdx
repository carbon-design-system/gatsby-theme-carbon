...
1. testing content within lists to see if spacing is weird or not
   ...
   Testing a paragraph here

   ```
   Testing a code snippet here
   ```
...
4. testing
   ...
   - testing nested list item here
     - nested nested li
     - nested nested li
   - another nested list item
   - nested list item
   - going to test an image after a nested list item
