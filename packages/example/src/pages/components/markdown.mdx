...
Since the h1 role effectively consumed by the page header, we now style h1 tags identically to h2 tags, except h1s have no margin-top.

This means the start of your content be either a [PageDescription](/components/PageDescription) or an h1 tag (single #). We recommend the former. For most content, we think PageDescription → AnchorLinks creates a nice hierarchy.
