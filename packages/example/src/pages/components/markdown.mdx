...
`gatsby-plugin-mdx` allows you to declare frontmatter in your `.mdx` files with triple dashes at the start and end of the data. The frontmatter can contain any additional data on the specific pages it is defined in, and it can be accessed in the GraphQL data layer. This data can include information like page title, SEO metadata, path, and more.
