...
The `<DoDontExample>` component will generally need to be placed inside `<DoDontExampleRow>` and `<Column>` components to align them to the grid at the correct size.
...
```jsx path=components/DoDontExample/DoDontExampleRow.js src=https://github.com/carbon-design-system/gatsby-theme-carbon/tree/master/packages/gatsby-theme-carbon/src/components/DoDontExample
<DoDontExampleRow>
  <Column colMd={4} colLg={4}>
    <DoDontExample type="do">
