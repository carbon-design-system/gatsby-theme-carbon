...
The `<ResourceCard>` component should be wrapped with a `<Column>` inside of a `<CardGroup>`. This allows the correct border placement between a group of cards. Learn more about the `<CardGroup>` [here](/components/CardGroup).
...
<CardGroup className="resource-card-group">
  <Column colMd={4} colLg={4} noGutterSm>
    <ResourceCard
