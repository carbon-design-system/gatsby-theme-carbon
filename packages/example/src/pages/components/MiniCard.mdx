...
```mdx path=components/MiniCard/MiniCard.js src=https://github.com/carbon-design-system/gatsby-theme-carbon/tree/master/packages/gatsby-theme-carbon/src/components/MiniCard
<CardGroup>
  <MiniCard title="26 characters per MiniCard" href="/demo">
    ![Github icon](/images/github-icon.png)
  </MiniCard>
