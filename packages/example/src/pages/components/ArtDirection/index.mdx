...
![Mobile image](./mobile.jpg) ![Tablet image](./tablet.jpg)
...
```mdx path=components/ArtDirection.js src=https://github.com/carbon-design-system/gatsby-theme-carbon/tree/master/packages/gatsby-theme-carbon/src/components/ArtDirection
<ArtDirection>
