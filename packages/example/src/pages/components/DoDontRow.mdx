...
The `<DoDontRow>` component is a custom row used alongside the `<DoDont>` component, which now include built in columns.
...
| -------- | -------- | -------- | ------- | ----------------------------------------------------------- |
| children | node     | yes      |         | child node, expects a markdown image or `<Video>` component |
...
| ...columProps | number   |          | `colMd=4, colLg=4` | specify column props                                                                                                                                                                                                                               |
