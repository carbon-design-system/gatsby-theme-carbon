...
<AnchorLinks>
  ...
  <AnchorLink>Gray 100 theme</AnchorLink>
</AnchorLinks>
...
You have the option of setting your background color to gray-100. To configure this you need to set the theme color in the front matter. You can view the [Galley](/gallery) page as an example.
