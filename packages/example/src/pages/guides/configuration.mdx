...
In order to change the source account for the [`MediumPosts`](/components/MediumPosts) component, provide the desired account with the `mediumAccount` option.
...
- `mediumAccount` - changes the source account for the [MediumPosts](/components/MediumPosts) component.
