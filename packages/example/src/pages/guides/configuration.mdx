...
To remove the link, remove the section that begins `options` through to its' closing brackets. If after deleting, your options object is empty, delete that as well.
