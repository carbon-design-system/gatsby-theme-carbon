...
With the header navigation style, the items on your page will be further left-aligned to allow for more content space.

**Just a note:** In mobile, when the header navigation is enabled, the left nav will persist.
## Edit on GitHub link
