...
Please provide configuration for enabling or disabling Switcher. Otherwise just like how you provided 
shadowed versions of Navlinks, Header & Footer if you can provide shadowed version of Switcher
it would be great, so that the links can be modifed.
