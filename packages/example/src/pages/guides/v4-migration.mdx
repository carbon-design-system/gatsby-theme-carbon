...
1. Run the codemods to modify any graphql queries that have schema changes
   ...
   Sourced from the
   [gatsby migration guide](https://www.gatsbyjs.com/docs/reference/release-notes/migrating-from-v4-to-v5/#graphql-schema-changes-to-sort-and-aggregation-fields)
