...
Remark plugins are useful extensions for instance when adding code blocks inside markdown (and mdx) files.
It is possible to bring additional remark plugins into the theme configuration. Here is a demonstration of an example.
See [configuration](/guides/configuration#additional-remark-plugins-and-override-existing-remark-plugin-configuration) guide for further details.

### Mermaid

Gatsby remark mermaid [plugin](https://www.gatsbyjs.org/packages/gatsby-remark-mermaid/) is an example of benefiting from additional remark plugins.
